 ...
 */
import type { ReporterStatisticResponse } from './reporterStatisticResponse';

export interface PagedResultOfReporterStatisticResponse {
  items?: ReporterStatisticResponse[];
  page?: number;
  hasMore?: boolean;
  totalCount?: number;
}
