...
public interface ITrailObstacleRepository
{
    ...
    Task<RepositoryResult> AnonymizeObstaclesByUserIdAsync(int userId, CancellationToken ctoken);
    Task<RepositoryResult<int>> DeleteExpiredObstaclesAsync(CancellationToken ctoken);
