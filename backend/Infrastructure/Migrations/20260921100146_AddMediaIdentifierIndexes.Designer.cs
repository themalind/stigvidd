...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260921100146_AddMediaIdentifierIndexes")]
    partial class AddMediaIdentifierIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Data.Entities.EmailVerificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Infrastructure.Data.Entities.HikeShare", b =>
                {
                    ...
                    b.Property<bool>("AllowResharing")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Infrastructure.Data.Entities.MailTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Infrastructure.Data.Entities.TrailObstacle", b =>
                {
                    ...
                    b.Property<Point>("IncidentLocation")
                        .HasColumnType("geometry(Point, 4326)")
                        .HasAnnotation("Sqlite:Srid", 4326);
                    ...
                    b.HasIndex("IncidentLocation");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("IncidentLocation"), "gist");
            ...
            modelBuilder.Entity("Infrastructure.Data.Entities.FacilityImage", b =>
                {
                    b.HasOne("Infrastructure.Data.Entities.Facility", "Facility")
                        .WithMany("Images")
                        .HasForeignKey("FacilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
