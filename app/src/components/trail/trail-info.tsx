  ...
  return (
    <Surface elevation={2} style={[s.container, { backgroundColor: theme.colors.surface }]}>
      ...
      <View style={s.infoDetailContainer}>
        <Text style={[s.title, { color: theme.colors.onSurface }]}>Markering:</Text>
        <Text style={{ color: theme.colors.onSurface }}>{trail.trailSymbol}</Text>
      </View>
      <View style={s.infoDetailContainer}>
        <Text style={[s.title, { color: theme.colors.onSurface }]}>Längd:</Text>
        <Text style={{ color: theme.colors.onSurface }}>{trail.trailLenght} km.</Text>
      </View>
      <View style={s.infoDetailContainer}>
